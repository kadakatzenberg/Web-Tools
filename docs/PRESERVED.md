...
- Resistance is clamped at zero, so negative CON/WIS grants no resistance and does **not** amplify damage. **[T]** *(diverges from the written rulebook — see `docs/MIGRATION.md`)*
